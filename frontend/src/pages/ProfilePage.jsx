...
const ProfilePage = ({ user }) => {
  return (
    <motion.section
      ...
      className="mx-auto w-full max-w-4xl clay-card rounded-[32px] p-6 shadow-[0_24px_60px_rgba(2,6,23,0.26)] sm:p-8"
    >
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <div className="rounded-[28px] clay-card p-5 shadow-[0_8px_32px_rgba(0,0,0,0.15)]">
