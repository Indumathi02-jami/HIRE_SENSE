      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl items-center px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid w-full gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
          ...
          <motion.section
            ...
            className="glass-card relative w-full overflow-hidden rounded-[30px] p-5 shadow-[0_30px_80px_rgba(2,6,23,0.6)] border border-cyan-500/10 sm:p-8"
          >
            ...
            <div className="relative">
              <span className="inline-flex rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.28em] text-slate-300">
                {eyebrow}
              </span>
